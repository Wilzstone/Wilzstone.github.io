    ...
    <div class="container">
        <div class="row mt-3">
            <div class="col-4">
                ...
                <?php
                include 'koneksi.php';
                $panggil = $koneksi->query("SELECT * FROM pegawai where idpegawai='$_GET[edit]'");
                ?>
                <?php
                ...
                ?>
                    <form action="koneksi.php" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" name="idpegawai" value="<?= $row['idpegawai'] ?>" readonly>
